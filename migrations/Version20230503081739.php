 ...
 */
final class Version20230503081739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_ranking (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, run_id INT DEFAULT NULL, end DATETIME DEFAULT NULL, chronometre DATETIME DEFAULT NULL, INDEX IDX_DBEB31A4CB944F1A (student_id), INDEX IDX_DBEB31A484E3FEC4 (run_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tbl_student (id INT AUTO_INCREMENT NOT NULL, grade_id INT NOT NULL, lastname VARCHAR(50) NOT NULL, firstname VARCHAR(50) NOT NULL, gender VARCHAR(1) NOT NULL, mas DOUBLE PRECISION DEFAULT NULL, objective TIME DEFAULT NULL, note INT DEFAULT NULL, INDEX IDX_EC70A747FE19A1A8 (grade_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
